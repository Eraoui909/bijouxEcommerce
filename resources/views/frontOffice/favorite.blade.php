                    ...
                    <form>
                        ...
                        <div class="table-wrapper u-s-m-b-60">
                            <table>
                                ...
                                <tbody>
                                @foreach($favorites->products as $item)
                                    <tr>
                                    <td>
                                        <div class="cart-anchor-image">
                                            <a href="{{route("single.product", $item->id)}}" >
                                                <img src="{{asset("/uploads/products") . "/" . $item->pictures[0]->name}}" alt="Product">
                                                <h6>{{ $item->name }}</h6>
                                            </a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="action-wrapper">
                                            ...
                                            <a data-id="{{ $item->id }}" class="button button-outline-secondary fas fa-trash delete-from-favorite"></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
